...
Button.MouseButton1Click:Connect(function()
    ...
    local LOCAL_KEYS = {
       ...
       ["tysfh45fh"] = {user = "xiaoruo9", expire = "2030-12-24"},
       ["hjddh14lk"] = {user = "strawberry5ay", expire = "2030-12-31"},
       ["skefwmx41l"] = {user = "GTHHGSH", expire = "2030-12-31"},
       ["ihdjk45kl"] = {user = "cheems070828", expire = "2030-12-24"},
       ["王皓9178"] = {user = "yutidhdivd", expire = "2030-12-24"},
       ["wygsnvko"] = {user = "zdclll2", expire = "2030-12-24"},
       ["djcnsujd45"] = {user = "18hbibmv", expire = "2030-12-24"},
       ["poksujd45"] = {user = "pks664", expire = "2030-12-24"},
       ["hidhf42kd"] = {user = "gwnhnys", expire = "2030-12-24"},
       ["siqbgs45o"] = {user = "wscmr7", expire = "2030-12-24"},
       ["kaowg45w2"] = {user = "msy357610", expire = "2030-12-24"},
       ["ikoa42n3"] = {user = "RRRRYeeeeeeeeeeeeeee", expire = "2030-12-24"},
       ["kghlz74hz"] = {user = "jhxmeiyoujibo", expire = "2030-12-24"},
       ["tifgnjk47"] = {user = "chiocnc", expire = "2030-12-24"},
       ["罗宝9178"] = {user = "KsXh352", expire = "2030-12-24"},
       ["qifsm45h7"] = {user = "drffrt_8", expire = "2030-12-24"},
       ["hdgx57kl"] = {user = "gfty5852", expire = "2030-12-24"},
       ["qabd76sh"] = {user = "gdlgkdzkggzkgxo", expire = "2030-12-24"},
       ["khzd57i2"] = {user = "hfucgjh", expire = "2030-12-24"},
       ["iwjgsn2"] = {user = "CSBNB66", expire = "2030-12-24"},
       ["er45n4a"] = {user = "cnvg2", expire = "2030-12-24"},
       ["qwazh97k"] = {user = "114514ophp", expire = "2030-12-24"},
       ["koddh74k"] = {user = "qpalzm258029", expire = "2030-12-24"},
       ["plkn47ce"] = {user = "ywensa4", expire = "2030-12-24"},
       ["dawk24ke"] = {user = "bsibvemdx", expire = "2030-12-24"},
       ["touy42n4g"] = {user = "yournotThe06", expire = "2030-12-24"},
       ["opu5aznk"] = {user = "lskzsaowm", expire = "2030-12-24"},
       ["knv74zy"] = {user = "cnm7891778", expire = "2030-12-24"},
       ["alpew84k"] = {user = "er57429", expire = "2030-12-24"},
       ["ekx46dfk"] = {user = "HPMK00", expire = "2030-12-24"},
       ["kelas94k"] = {user = "ikun45533", expire = "2030-12-24"},
